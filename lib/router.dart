...
import 'package:etherwallet/wallet_exchange_page.dart';
...
Map<String, WidgetBuilder> getRoutes(context) {
  return {
    ...
    '/Exchange': (BuildContext context) => WalletTransferProvider(
          // ignore: prefer_const_constructors
          builder: (context, store) => WalletExchangePage(
    ...
    '/txn': (BuildContext context) => MyApp()
  };
}
